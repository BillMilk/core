...
export const messages: Record<AppLocale, Record<string, string>> = {
  'zh-CN': {
    ...
    'This directory contains files but is not a Git repository. Agent Tower can initialize Git, add files not excluded by .gitignore, and create the initial commit before creating the project.':
      '该目录包含文件但尚未初始化 Git。Agent Tower 可以初始化 Git，添加未被 .gitignore 排除的文件，并创建首次提交后再创建项目。',
    'Initialize Git': '初始化 Git',
    'Initializing Git...': '正在初始化 Git...',
    'Initialize Git for this project?': '为此项目初始化 Git？',
    'Agent Tower will initialize Git in this directory, add files not excluded by .gitignore, and create the initial commit. Existing source files will not be modified.':
      'Agent Tower 将在此目录中初始化 Git，添加未被 .gitignore 排除的文件并创建首次提交。现有源码文件不会被修改。',
    'Git initialized. Team mode is now available.': 'Git 初始化完成，现在可以使用团队模式。',
    'Failed to initialize Git': 'Git 初始化失败',
    ...
    'Thinking': '思考中',
    'Calling tool': '调用工具',
    'Generating output': '生成输出',
    'Waiting for permission': '等待授权',
    'Session duration': '会话时长',
    'Tool calls': '工具调用',
    'Reported by the CLI. Core does not estimate or compress this context.': '数据由 CLI 报告，Core 不估算也不压缩上下文。',
    'This CLI has not reported context usage yet.': '此 CLI 尚未报告上下文用量。',
    ...
    'Recovering': '恢复中',
    'Merge failed': '合并失败',
    '{count} blockers': '{count} 个阻塞项',
    'Ready to claim': '可领取',
    'Worker': '执行者',
    'Unassigned': '未分配',
    'Readiness': '就绪状态',
    'Blocked by {count} dependencies': '被 {count} 个依赖阻塞',
    'Waiting for state transition': '等待状态流转',
    'Attempts': '尝试次数',
    'Last heartbeat': '最近心跳',
    'Claimed': '领取时间',
    'Last error': '最近错误',
    'No error recorded': '暂无错误记录',
    'Task workflows': '任务工作流',
    'Durable DAG runs rooted at this task.': '以当前任务为根节点的持久化 DAG 运行。',
    '{count} nodes': '{count} 个节点',
    'Orchestration controls': '编排控制',
    'Only transitions allowed by the backend state machine are shown.': '仅显示后端状态机允许的流转操作。',
    'Task marked ready': '任务已标记为就绪',
    'Mark ready': '标记就绪',
    'Move to {status}': '流转到{status}',
    'Reason (optional)': '原因（可选）',
    'Worker ID': '执行者 ID',
    'Task claimed': '任务已领取',
    'Claim task': '领取任务',
    'Heartbeat sent': '心跳已发送',
    'Send heartbeat': '发送心跳',
    'Prerequisites': '前置依赖',
    'This task waits for these tasks to finish.': '当前任务需等待这些任务完成。',
    'Select a task': '选择任务',
    'Add': '添加',
    'No prerequisites': '暂无前置依赖',
    'Remove dependency': '移除依赖',
    'Dependents': '下游任务',
    'These tasks are waiting for this task.': '这些任务正在等待当前任务完成。',
    'No dependents': '暂无下游任务',
    'Orchestration activity': '编排活动',
    'Durable task events recorded by the backend.': '后端持久化记录的任务事件。',
    'No orchestration events yet': '暂无编排事件',
    'Dependency added': '依赖已添加',
    'Dependency removed': '依赖已移除',
    'Orchestration status updated': '编排状态已更新',
    'Task created': '任务已创建',
    'Task updated': '任务已更新',
    ...
    'Task failed': '任务失败',
    'Task deleted': '任务已删除',
    'Workflow initialized': '工作流已初始化',
    'Workflow node created': '工作流节点已创建',
    'Workflow completed': '工作流已完成',
    'Human input requested': '已请求人工输入',
    'Human input answered': '人工输入已回答',
    '{count} awaiting your input': '{count} 项等待你输入',
    'Waiting for your input': '等待你的输入',
    'Only dependent branches are paused. Other ready DAG branches continue running.':
      '仅暂停依赖该决定的分支，其他已就绪的 DAG 分支会继续执行。',
    'Enter your answer for this DAG node': '请输入对这个 DAG 节点的回答',
    'The answer is recorded in TaskEvent and the exact node resumes automatically.':
      '回答会记录到 TaskEvent，并自动恢复对应节点。',
    'Submit answer and continue': '提交回答并继续',
    'Answer submitted; the DAG node is ready to resume': '回答已提交，DAG 节点已可恢复',
    'Open the TeamRun root task to answer this question.': '请打开 TeamRun 根任务回答此问题。',
  },
  en: {
    '设置': 'Settings',
    '通用': 'General',
    ...
    'Reported by the CLI. Core does not estimate or compress this context.': 'Reported by the CLI. Core does not estimate or compress this context.',
    'This CLI has not reported context usage yet.': 'This CLI has not reported context usage yet.',
