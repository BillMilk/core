...
export const messages: Record<AppLocale, Record<string, string>> = {
  ...
  en: {
    ...
    'Agent 将跳过确认并禁用沙盒保护。': 'The agent will skip confirmations and disable sandbox protection.',
    ...
    '每次询问': 'Ask Every Time',
    '自动批准': 'Auto Approve',
    'ACP 权限策略必须为 ASK 或 AUTO_APPROVE': 'ACP permission policy must be ASK or AUTO_APPROVE',
